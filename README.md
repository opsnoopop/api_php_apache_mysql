# PHP Apache API with MySQL

A simple PHP Apache API application and MySQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_apache_mysql.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_apache_mysql
```
